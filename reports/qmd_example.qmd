...
[Government of Canada's Open Data website](https://open.canada.ca/en/using-open-data): [@horses1; @horses2].
...
![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse-largest-pop width=60%}


In @fig-horse-largest-pop we zoom in and look at the province of  `{python} largest_sd`, which had the largest spread of values in terms of standard deviation.
